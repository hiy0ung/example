...
const student1 = new Students('황현지', 30);
const student2 = new Students('권세혁', 40);
...
// interface IMixed = IUser | string; // '='를 사용할 수 없기 때문에 union 불가
