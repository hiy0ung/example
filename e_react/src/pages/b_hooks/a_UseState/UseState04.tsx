...
1. 폼 필드 (사용자와 상호작용 하기 위함 / 입력값 서버로 보내기 등)
...
export default function UseState04() {
  //! 폼 데이터 상태 관리
  const [formData, setFormDate] = useState<IFormData>({
    id: "",
    password: "",
    email: "",
  });
  ...
  const handleSignUpSubmit = (e: React.FormEvent) => {
    ...
    //? 오류 상태를 업데이트 (tempErrors는 빈 문자열이므로 다 입력 되었을 때 정상적으로 출력됨)
