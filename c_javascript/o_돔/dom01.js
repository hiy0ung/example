...
//# 2. DOM 사용 방법
// : JS에서 DOM에 접근하는 경우 요소를 선택, 추가, 수정, 삭제하는 메소드와 속성에 접근 O
// >> CRUD

//# 3. DOM 조작 방법

// 1) DOMContentLoaded 이벤트
// : JS내에서 문서 객체를 조작할 때 사용
...
// EX) 태그, #아이디, .클래스, 선택자A 후손B(자식 요소 선택자) - 띄어쓰기로 구분+
...
document.addEventListener('DOMContentLoaded', () => {
  // querySelectorAll()
  // : 문서 객체를 어러 개 추출하여 배열로 읽음

  const items = document.querySelectorAll('li');

  // 각각의 요소에 접근하려면 배열 메서드 활용
  items.forEach(item => {
