...
console.log(snacks.indexOf('꼬깔콘')); // -1 (없음 >> 1 출력)
...
// 2) 요소 삭제
// pop()*****: 배열의 마지막 요소를 제거, 그 제거된 요소를 반환(빈 배열은 undefined 반환) (중요 !!)
...
// sort()*****: 배열 요소 정렬 (오름차순)
console.log(fruits.sort()); // [ 'Strawberry', 'Mango', 'Peach' ]
