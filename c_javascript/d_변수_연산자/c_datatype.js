...
// 123456
let stringrNum1 = String(num1);
let stringrNum2 = String(num2);

console.log(stringrNum1 + stringrNum2); // 123456


// 2. Number() 함수

let notANumber = '안녕하세요'; // 문자열
console.log(Number(notANumber)); // NaN: Not A Number - 숫자로 변현활 수 없는 값을 변환 시도할 경우

console.log(Number(stringrNum1)); // 123
console.log(typeof Number(stringrNum1)); // Number
