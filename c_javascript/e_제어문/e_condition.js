...
let stringData = ''; // 빈 문자열의 경우 'false'값으로 인식
let numberData = 0; // 0의 값 경우 'false'값으로 인식

// false 데이터에 !(not) 연산자를 사용하여 조건문 실행 (false값은 조건문 실행 안함)
if (!stringData) {
...
// (2) if문 형태의 로지들은 삼항 연산자로 변환이 가능
// 조건문의 경우 코드블록의 다양한 표현이 가능
// 삼항 연산자의 경우 코드의 간결성과 {} 사용을 하지 않아 다양한 활용이 가능
