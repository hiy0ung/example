...
// : 첫 번째 호출에서는 initialValue값이 지정 (처음에는 축적된 값이 없으므로)
...
console.log(typeof combinedCar); // string (하나  의 문자열임을 확인)
...
console.log(firstOverFiveIndex); // 3 (6이 있는 인덱스 번호)