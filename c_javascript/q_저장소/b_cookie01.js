...
// >> document.cookie에 문자열을 할다앟면 생성과 수정이 가능
// (필수) 쿠키의 이름, 값
...
// - 경로값: 해당 웹 페이지의 쿠키값에 접근할 수 있는 경로를 지정
...
date.setTime(date.getTime() + (1 * 60 * 60 *1000)); // 현재 시간에 1시간을 추가 >> 시간 분 초 밀리초

let expires = "expires=" + date.toUTCString(); // 시간을 협성 세계시 문자열로 변환
// "expires=시간문자열"

document.cookie = "userAge=50;" + expires + "; path=/"
// "userAger=50; expires=시간문자열; path=/;"
