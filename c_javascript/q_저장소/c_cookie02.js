...
function getCookieValue(cookieName) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    if(name === cookieName) { //! 오류남 뭐지
      return parts[1] || ''; // 값이 있으면 반환하고, 해당 이름에 값이 없으면 빈 문자열 반환
    }
  }
...
// document.cookie = "이름=shy; path=/;"
// let date3 = new Date();
// date3.setTime(date3.getTime() + (1 * 60 * 60 *1000));
// let expires3 = "expires=" + date3.toUTCString();