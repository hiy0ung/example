...
// cf) username, userName name만 특별하게 하나의 단어로 인식해서 username으로 사용할 수 있음 다른 건 X ex)userage X
...
// >> JSON.stringfy() 메서드를 사용 (문자열화하는 메서드)
...
//? 로컬 스토리지 데이터 삭제
// : localStrage.removeItem(key); // 개별 데이터 삭제
// : localStrage.clear(); // 전체 데이터 삭제
